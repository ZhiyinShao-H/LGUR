...
# vq = SOHO_Pre_VD(3, 5, decay=0.1,max_decay=0.99)
# inputs_flatten = torch.FloatTensor([[2,1,3,4,1],[6,1,7,1,3],[15,1,14,4,111]])
# inputs_flatten_norm = inputs_flatten/inputs_flatten.norm(p=2,dim=1,keepdim=True)
# embed_norm = vq.embed/vq.embed.norm(p=2,dim=1,keepdim=True)
# a = torch.matmul(inputs_flatten_norm,embed_norm.t())
# print(a)
# print(vq.embed)
# print(vq.embed_avg)
# quantized_pt, indices = vq(inputs_flatten)
# inputs_flatten_norm = inputs_flatten/inputs_flatten.norm(p=2,dim=1,keepdim=True)
# embed_norm = vq.embed/vq.embed.norm(p=2,dim=1,keepdim=True)
# a = torch.matmul(inputs_flatten_norm,embed_norm.t())
# print(a)
